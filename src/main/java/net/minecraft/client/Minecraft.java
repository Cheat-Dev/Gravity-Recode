...
//        this.drawSplashScreen(this.renderEngine);
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Client.INSTANCE.getClientInfo().getLoadingTitle());
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("pulsabo/images/gravity16.png"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("pulsabo/images/gravity32.png"));
    ...
    private void runGameLoop() throws IOException {
        ...
        Client.INSTANCE.setRenderDeltaTime(deltaTime);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    Client.INSTANCE.getPubSubEventBus().publish(new KeyboardPressEvent(k));
                    KeyBinding.onTick(k);
                }

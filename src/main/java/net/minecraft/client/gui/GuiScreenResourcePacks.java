...
public class GuiScreenResourcePacks extends GuiScreen
{
    ...
    public void initGui()
    {
        this.buttonList.add(new GuiButton(2, 173 + 75 / 2 - 154, this.height - 48, 150, 20, I18n.format("resourcePack.openFolder")));
        this.buttonList.add(new GuiButton(1, 173 + 75 / 2 + 4, this.height - 48, 150, 20, I18n.format("gui.done")));

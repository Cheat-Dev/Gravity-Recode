...
public class UsernameField extends Gui {
	...
	public UsernameField(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5) {
	...
	public void drawTextBox() {
		if (this.func_73778_q()) {
			if (this.getEnableBackgroundDrawing()) {
				RoundedUtil.drawSmoothRoundedRect(this.xPos - 1, this.yPos - 1, this.xPos + this.width + 1, this.yPos + this.height + 1,
						15, -6250336);
				RoundedUtil.drawSmoothRoundedRect(this.xPos, this.yPos, this.xPos + this.width, this.yPos + this.height,15,
						new Color(10, 10, 15, 235).getRGB());
			}
			...
			if (var4.length() > 0) {
				...
				var9 = Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.text, (float)var7, (float)var8, var1);
			}
			boolean var10 = this.cursorPosition < this.text.length() || 25 >= this.getMaxStringLength();
			int var11 = var9;
			if (!var5) {
	...
	private void drawCursorVertical(int par1, int par2, int par3, int par4) {
		...
		var7.reset();
		var7.color(par1, par4, 0, var5);
		var7.color(par3, par4, 0, var5);
		var7.color(par3, par2, 0, var5);
		var7.color(par1, par2, 0, var5);
		var7.finishDrawing();

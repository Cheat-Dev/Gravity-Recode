package team.gravityrecode.clientbase.impl.util.util.render.secondary;

import net.minecraft.client.gui.ScaledResolution;
import net.minecraft.util.ResourceLocation;
import team.gravityrecode.clientbase.api.util.MinecraftUtil;
import team.gravityrecode.clientbase.impl.util.util.client.FileUtil;
...
public class RuntimeShader implements MinecraftUtil {
    private final int programID;

    public RuntimeShader(String fragmentShaderLoc, String vertexShaderLoc) {
    ...
    public RuntimeShader(String fragmentShaderLoc) {

package team.gravityrecode.clientbase.impl.util.render.secondary;
...
import static team.gravityrecode.clientbase.impl.util.render.RenderUtil.glColor;
...
public class RenderUtils
{
    ...
    public static void drawRect(float x, float y, float x1, float y1, int color) {
        RoundedUtil.enableGL2D();
        glColor(color);
        drawRect(x, y, x1, y1);
        RoundedUtil.disableGL2D();
    }
    ...
    public static double progressiveAnimation(final double now, final double desired, final double speed) {
        ...
        if (dif > 0.0) {
            double animationSpeed = MathUtil.round(Math.min(10.0, Math.max(0.05, 144.0 / fps * (dif / 10.0) * speed)), 0.05);
    ...
    public static void drawCheckMark(final float x, final float y, final int width, final int color) {
        ...
        GL11.glVertex2d(x + width - 6.5, y + 3.0f);
        GL11.glVertex2d(x + width - 11.5, y + 10.0f);
        GL11.glVertex2d(x + width - 13.5, y + 8.0f);
        GL11.glEnd();
        GL11.glEnable(3553);
        GL11.glPopMatrix();
        GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
